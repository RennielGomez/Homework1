...
Notes:
- Use `to_timestamp(..., 'DD-MM-YYYY')` consistently or switch to ISO date literals if your SQL dialect supports them.
- I removed `LIMIT 1` from the counting query and added clear aliases for readability.
